...
/* Start of snippet added for South Pacific ICPC DOMjudge compatibility */
#ifdef DOMJUDGE
#  define DEFAULT_EXIT_CODE_GOOD 0
#else
#  define DEFAULT_EXIT_CODE_GOOD 42
#endif
#define DEFAULT_EXIT_CODE_BAD 43

#define OK_EXIT_CODE DEFAULT_EXIT_CODE_GOOD
#define WA_EXIT_CODE DEFAULT_EXIT_CODE_BAD
#define PE_EXIT_CODE 43
#define FAIL_EXIT_CODE 43
#define DIRT_EXIT_CODE 43
#define UNEXPECTED_EOF_EXIT_CODE 43
/* End of snippet added for South Pacific ICPC DOMjudge compatibility */
...
void registerTestlibCmd(int argc, char *argv[]) {
    ...
    resultName = (std::string(argv[3])+std::string("/judgemessage.txt")).c_str();
    ouf.init(stdin  , _output);
    /* End of snippet added for South Pacific ICPC DOMjudge compatibility */
