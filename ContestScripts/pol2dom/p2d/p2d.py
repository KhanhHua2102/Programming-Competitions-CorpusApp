...
from p2d import (domjudge_api,
                 ...
                 generate_contest_latex,
                 generate_problem_latex,
    ...
    for problem in config['problems']:
        ...
        if args.convert:
            ...
            p2d_utils.manage_convert(
                config,
                os.path.join(contest_dir, 'polygon', problem['label']),
                os.path.join(contest_dir, 'domjudge', problem['label']),
                os.path.join(contest_dir, 'tex'),
                problem)
            p2d_utils.save_config_yaml(config, contest_dir)

            generate_problem_latex.generate_problem_latex(os.path.join(contest_dir, 'polygon'), os.path.join(contest_dir, 'domjudge'))
            generate_contest_latex.create_contest_latex(os.path.join(contest_dir, 'domjudge'), os.path.join(contest_dir, 'domjudge'))
