...
python -m unittest tests.test_create_contest_tex
"""
import unittest
from p2d.generate_contest_latex import get_label_from_path, is_valid_label, extract_contest_data, escape_special_characters
...
class Test(unittest.TestCase):
    ...
    def test_extract_contest_tex_data(self):
        self.assertEqual(
            extract_contest_data("xxRegionals"), 
            {
                'A': {'problemname': 'A Menace 2 \\$ociety'}, 
        ...
        self.assertEqual(
            extract_contest_data("regionals2023"), 
            {
                'A': {'problemname': 'Attention Stones'}, 
